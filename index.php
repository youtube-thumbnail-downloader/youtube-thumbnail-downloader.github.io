...
<head>
    ...
    <title><?php echo "YThumb Down - Download HD Youtube Video Thumbnails in all qualities"; ?></title>
    <meta name="description" content="<?php echo "Download youtube videos thumbnail in HD quality for free. You can save any YT video thumbnail image online with this downloader, no software need to download or install."; ?>" />
    <!--<link rel="shortcut icon" href="/favicon.ico" type="image/x-icon">-->
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="<?php echo "YThumb Down - Download HD Youtube Video Thumbnails in all qualities"; ?>" />
    <meta property="og:description" content="<?php echo "Download youtube videos thumbnail in HD quality for free. You can save any YT video thumbnail image online with this downloader, no software need to download or install."; ?>" />
    <meta property="og:url" content="https://ythumbdown.github.io/ythumbdown/" />
    <meta property="og:site_name" content="YThumb Down" />
    <!--<meta property="og:image" content="https://.png"/>  -->
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:title" content="<?php echo "YThumb Down - Download HD Youtube Video Thumbnails in all qualities"; ?>" />
    <meta name="twitter:description" content="<?php echo "Download youtube videos thumbnail in HD quality for free. You can save any YT video thumbnail image online with this downloader, no software need to download or install."; ?>" />
    <!--<meta name="twitter:image" content="url" />
    <meta name="twitter:site" content="@ythumbdown" />
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-CB342C63ZY"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-CB342C63ZY');
</script>
</head>
